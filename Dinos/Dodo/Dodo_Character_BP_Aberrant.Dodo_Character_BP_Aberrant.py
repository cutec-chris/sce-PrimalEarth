import sys,sce
class Dodo_Character_BP_Aberrant(sce.Aberration):
   def __init__(self):
       super().__init__(self)
       name = 'Aberrant Dodo'
       ...
       taming = {'nonViolent': False, 'violent': True, 'tamingIneffectiveness': 1.333333, 'affinityNeeded0': 450, 'affinityIncreasePL': 22.5, 'torporDepletionPS0': 0.3, 'foodConsumptionBase': 0.000868, 'foodConsumptionMult': 2880.184}
