import sys,sce
class Coel_Character_BP_IceFishMission(sce.BaseCreature):
   def __init__(self):
       super().__init__(self)
       name = 'Coelacanth'
       blueprintPath = '/Game/PrimalEarth/Dinos/Coelacanth/Coel_Character_BP_IceFishMission.Coel_Character_BP_IceFishMission'
       variants = ['IceFishing']
