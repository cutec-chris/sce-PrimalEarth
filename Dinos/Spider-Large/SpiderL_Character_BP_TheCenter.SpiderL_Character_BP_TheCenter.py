import sys,sce
class SpiderL_Character_BP_TheCenter(sce.BaseCreature):
   def __init__(self):
       super().__init__(self)
       ...
       fullStatsRaw = [[356400, 0.2, 0.27, 0.5, 0], [150, 0.1, 0.1, 0, 0], [100000, 0.06, 0, 0.5, 0], [150, 0.1, 0.1, 0, 0], [1500, 0.1, 0.1, 0, 0], None, None, [4000, 0.02, 0.04, 0, 0], [1, 0.05, 0.1, 0.5, 0.4], [1, 0, 0.01, 0.151, 0], None, None]
