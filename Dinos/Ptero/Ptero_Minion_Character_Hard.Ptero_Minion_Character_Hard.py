import sys,sce
class Ptero_Minion_Character_Hard(sce.BaseCreature):
   def __init__(self):
       super().__init__(self)
       name = 'Pteranodon'
       blueprintPath = '/Game/PrimalEarth/Dinos/Ptero/Ptero_Minion_Character_Hard.Ptero_Minion_Character_Hard'
       variants = ['Alpha', 'Boss', 'Minion']
       isFlyer = True
       fullStatsRaw = [[1560, 0.2, 0.15, 0.5, 0], [150, 0.05, 0.04, 0, 0], [120, 0.06, 0, 0.5, 0], [150, 0.1, 0.1, 0, 0], [1200, 0.1, 0.1, 0, 0.15], None, None, [120, 0.02, 0.03, 0, 0], [1, 0.05, 0.075, 0.65, 0.4], [1, 0, 0.02, 0.35, 0], None, None]
       altBaseStats = {'0': 650}
