import sys,sce
class Baryonyx_Character_BP(sce.Dinos):
   def __init__(self):
       super().__init__(self)
       name = 'Baryonyx'
       ...
       colors = [{'name': 'Body', 'colors': ['Black', 'Dark Grey', 'Dino Dark Brown', 'Dino Dark Green', 'Dino Dark Orange', 'Dino Dark Yellow', 'Dino Darker Grey', 'Dino Medium Brown', 'Dino Medium Green']}, {'name': 'Spines', 'colors': ['BigFoot0', 'Black', 'Dark Grey', 'Dino Dark Brown', 'Dino Dark Green', 'Dino Darker Grey', 'Dino Light Yellow', 'Dino Medium Brown', 'Dino Medium Green']}, None, None, {'name': 'Stripes', 'colors': ['BigFoot5', 'Dark Grey', 'DarkWolfFur', 'Dino Dark Brown', 'Dino Dark Grey', 'Dino Dark Yellow', 'Dino Light Brown', 'Dino Medium Brown']}, {'name': 'Underside', 'colors': ['BigFoot0', 'BigFoot4', 'BigFoot5', 'Dino Light Brown', 'Dino Light Yellow', 'Dino Medium Brown', 'Light Grey', 'WolfFur']}]
