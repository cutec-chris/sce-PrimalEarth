import sys,sce
class Mosa_Character_BP_Mega_Cave(sce.BaseCreature):
   def __init__(self):
       super().__init__(self)
       name = 'Alpha Mosasaur'
       blueprintPath = '/Game/PrimalEarth/Dinos/Mosasaurus/Mosa_Character_BP_Mega_Cave.Mosa_Character_BP_Mega_Cave'
       variants = ['Cave', 'Mega']
