import sys,sce
class Dragonfly_Character_BP_Aberrant(sce.Aberration):
   def __init__(self):
       super().__init__(self)
       name = 'Aberrant Meganeura'
       blueprintPath = '/Game/PrimalEarth/Dinos/Dragonfly/Dragonfly_Character_BP_Aberrant.Dragonfly_Character_BP_Aberrant'
       variants = ['Aberrant']
       isFlyer = True
