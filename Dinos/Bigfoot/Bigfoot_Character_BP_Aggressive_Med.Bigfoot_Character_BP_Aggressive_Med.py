import sys,sce
class Bigfoot_Character_BP_Aggressive_Med(sce.BaseCreature):
   def __init__(self):
       super().__init__(self)
       name = 'Gigantopithecus'
       blueprintPath = '/Game/PrimalEarth/Dinos/Bigfoot/Bigfoot_Character_BP_Aggressive_Med.Bigfoot_Character_BP_Aggressive_Med'
       variants = ['Beta', 'Boss']
       fullStatsRaw = [[1280, 0.1, 0.27, 0.5, 0], [300, 0.1, 0.1, 0, 0], [1100, 0.06, 0, 0.5, 0], [150, 0.1, 0.1, 0, 0], [1500, 0.1, 0.1, 0, 0], None, None, [220, 0.02, 0.04, 0, 0], [1, 0.04, 0.1, 0.5, 0.4], [1, 0, 0.01, 0.06, 0], None, None]
       altBaseStats = {'0': 640}
       immobilizedBy = []
