import sys,sce
class Bigfoot_Character_BP_Aggressive(sce.BaseCreature):
   def __init__(self):
       super().__init__(self)
       name = 'Gigantopithecus'
       blueprintPath = '/Game/PrimalEarth/Dinos/Bigfoot/Bigfoot_Character_BP_Aggressive.Bigfoot_Character_BP_Aggressive'
       variants = ['Boss', 'Gamma']
