import sys,sce
class Monkey_Character_BP_Aggressive(sce.BaseCreature):
   def __init__(self):
       super().__init__(self)
       name = 'Mesopithecus'
       blueprintPath = '/Game/PrimalEarth/Dinos/Monkey/Monkey_Character_BP_Aggressive.Monkey_Character_BP_Aggressive'
       variants = ['Boss', 'Gamma']
