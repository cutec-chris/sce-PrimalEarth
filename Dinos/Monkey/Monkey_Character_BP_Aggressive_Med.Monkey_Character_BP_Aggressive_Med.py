import sys,sce
class Monkey_Character_BP_Aggressive_Med(sce.BaseCreature):
   def __init__(self):
       super().__init__(self)
       name = 'Mesopithecus'
       blueprintPath = '/Game/PrimalEarth/Dinos/Monkey/Monkey_Character_BP_Aggressive_Med.Monkey_Character_BP_Aggressive_Med'
       variants = ['Beta', 'Boss']
       fullStatsRaw = [[230, 0.2, 0.27, 0.5, 0], [100, 0.1, 0.1, 0, 0], [60, 0.06, 0, 0.5, 0], [150, 0.1, 0.1, 0, 0], [450, 0.1, 0.1, 0, 0.15], None, None, [70, 0.02, 0.04, 0, 0], [1, 0.05, 0.1, 1, 0.4], [1, 0, 0.01, 1.3, 0], None, None]
       altBaseStats = {'0': 115}
       immobilizedBy = []
