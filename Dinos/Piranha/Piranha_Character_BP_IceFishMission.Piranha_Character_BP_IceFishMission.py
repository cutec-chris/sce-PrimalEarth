import sys,sce
class Piranha_Character_BP_IceFishMission(sce.BaseCreature):
   def __init__(self):
       super().__init__(self)
       name = 'Piranha'
       blueprintPath = '/Game/PrimalEarth/Dinos/Piranha/Piranha_Character_BP_IceFishMission.Piranha_Character_BP_IceFishMission'
       variants = ['IceFishing']
