import sys,sce
class Dimorph_Character_BP_Aggressive_DragonBoss(sce.BaseCreature):
   def __init__(self):
       super().__init__(self)
       name = 'Dimorphodon'
       blueprintPath = '/Game/PrimalEarth/Dinos/Dimorphodon/Dimorph_Character_BP_Aggressive_DragonBoss.Dimorph_Character_BP_Aggressive_DragonBoss'
       variants = ['Boss', 'Gamma', 'Minion']
       isFlyer = True
       fullStatsRaw = [[264, 0.2, 0.27, 0.5, 0], [150, 0.1, 0.1, 0, 0], [100, 0.06, 0, 0.5, 0], [150, 0.1, 0.1, 0, 0], [900, 0.1, 0.1, 0, 0], None, None, [50, 0.02, 0.04, 0, 0], [1, 0.05, 0.1, 0.5, 0.4], [1, 0, 0.01, 0, 0], None, None]
       immobilizedBy = []
