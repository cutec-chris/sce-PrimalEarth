import sys,sce
class Dimorph_Character_BP_Aggressive_DragonBoss_Med(sce.BaseCreature):
   def __init__(self):
       super().__init__(self)
       name = 'Dimorphodon'
       blueprintPath = '/Game/PrimalEarth/Dinos/Dimorphodon/Dimorph_Character_BP_Aggressive_DragonBoss_Med.Dimorph_Character_BP_Aggressive_DragonBoss_Med'
       variants = ['Beta', 'Boss', 'Minion']
       isFlyer = True
       fullStatsRaw = [[528, 0.2, 0.27, 0.5, 0], [150, 0.1, 0.1, 0, 0], [100, 0.06, 0, 0.5, 0], [150, 0.1, 0.1, 0, 0], [900, 0.1, 0.1, 0, 0], None, None, [50, 0.02, 0.04, 0, 0], [1, 0.05, 0.1, 0.5, 0.4], [1, 0, 0.01, 0, 0], None, None]
       altBaseStats = {'0': 264}
       immobilizedBy = []
