import sys,sce
class CrystalWyvern_Character_BP_Ember(sce.Dinos):
   def __init__(self):
       super().__init__(self)
       name = 'Ember Crystal Wyvern'
       blueprintPath = '/Game/PrimalEarth/Dinos/CrystalWyvern/CrystalWyvern_Character_BP_Ember.CrystalWyvern_Character_BP_Ember'
       ...
       colors = [{'name': 'Body Main', 'colors': ['Brown', 'Coral', 'Dino Dark Orange', 'DragonBase0', 'DragonBase1', 'DragonFire', 'Light Autumn', 'NearBlack', 'NearWhite']}, None, {'name': 'Scales Main', 'colors': ['Dino Light Orange', 'Light Orange', 'Light Yellow', 'Orange', 'Peach']}, None, {'name': 'Fins Highlight', 'colors': ['Dino Light Orange', 'Light Orange', 'Light Yellow', 'Orange', 'Peach']}, {'name': 'Body Highlights', 'colors': ['Dino Light Orange', 'Light Orange', 'Light Yellow', 'Orange', 'Peach']}]
