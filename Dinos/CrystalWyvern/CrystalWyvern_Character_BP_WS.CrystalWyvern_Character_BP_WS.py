import sys,sce
class CrystalWyvern_Character_BP_WS(sce.Dinos):
   def __init__(self):
       super().__init__(self)
       name = 'Tropical Crystal Wyvern'
       blueprintPath = '/Game/PrimalEarth/Dinos/CrystalWyvern/CrystalWyvern_Character_BP_WS.CrystalWyvern_Character_BP_WS'
       ...
       colors = [{'name': 'Body Main', 'colors': ['Dino Light Blue', 'Dino Light Green', 'Dino Light Purple', 'DragonGreen1', 'DragonGreen3', 'Glacial', 'Light Green', 'Light Pink', 'NearWhite', 'Powder Blue', 'Turquoise', 'WyvernBlue0']}, None, {'name': 'Scales Main', 'colors': ['Dino Light Blue', 'Dino Light Green', 'Dino Light Purple', 'DragonGreen1', 'DragonGreen3', 'Glacial', 'Light Green', 'Light Pink', 'NearWhite', 'Powder Blue', 'Turquoise', 'WyvernBlue0']}, None, {'name': 'Fins Highlight', 'colors': ['Dino Light Blue', 'Dino Light Green', 'Dino Light Purple', 'DragonGreen1', 'DragonGreen3', 'Glacial', 'Light Green', 'Light Pink', 'NearWhite', 'Powder Blue', 'Turquoise', 'WyvernBlue0']}, {'name': 'Body Highlights', 'colors': ['Dino Light Blue', 'Dino Light Green', 'Dino Light Purple', 'DragonGreen1', 'DragonGreen3', 'Glacial', 'Light Green', 'Light Pink', 'NearWhite', 'Powder Blue', 'Turquoise', 'WyvernBlue0']}]
