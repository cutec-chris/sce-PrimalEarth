import sys,sce
class Gorilla_Character_BP_TheCenter_Hard(sce.BaseCreature):
   def __init__(self):
       super().__init__(self)
       name = 'Megapithecus'
       ...
       fullStatsRaw = [[224000, 0, 0, 0.3, 0], [650, 0, 0, 0, 0], [350, 0.06, 0, 0.5, 0], [2000, 0, 0, 0, 0], [2600, 0, 0, 0, 0], None, None, [4000, 0.02, 0.02, 0, 0], [1, 0, 0, 0.3, 0.3], [1, 0, 0, 0, 0], None, None]
