import sys,sce
class SpiderS_Character_BP_Aggressive_Hard(sce.BaseCreature):
   def __init__(self):
       super().__init__(self)
       name = 'Araneo'
       blueprintPath = '/Game/PrimalEarth/Dinos/Spider-Small/SpiderS_Character_BP_Aggressive_Hard.SpiderS_Character_BP_Aggressive_Hard'
       variants = ['Alpha', 'Boss']
       fullStatsRaw = [[450, 0.2, 0.135, 0.5, 0], [100, 0.1, 0.1, 0, 0], [80, 0.06, 0, 0.5, 0], [150, 0.1, 0.1, 0, 0], [900, 0.1, 0.1, 0, 0], None, None, [100, 0.02, 0.08, 0, 0], [1, 0.05, 0.1, 0.5, 0.4], [1, 0, 0.01, 0.67, 0], None, None]
       altBaseStats = {'0': 150}
       immobilizedBy = []
