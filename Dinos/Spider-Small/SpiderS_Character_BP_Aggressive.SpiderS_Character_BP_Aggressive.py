import sys,sce
class SpiderS_Character_BP_Aggressive(sce.BaseCreature):
   def __init__(self):
       super().__init__(self)
       name = 'Araneo'
       blueprintPath = '/Game/PrimalEarth/Dinos/Spider-Small/SpiderS_Character_BP_Aggressive.SpiderS_Character_BP_Aggressive'
       variants = ['Boss', 'Gamma']
